...
import TopDestinationCard from "../card/TopDestinationCard";
const TopDestination = () => {
  return (
    <section className="">
      ...
      <div className="mt-[100px] flex w-full flex-col items-center justify-center gap-[30px] sm:flex-row">
        {Destination.map((item) => (
          ...
          //         objectFit="contain"
          //         alt={item.title}
          //         className="w-full items-center justify-center rounded-t-[30px] object-contain"
          //       />
          //     </div>
          //   </div>
